...
class Main extends Component {
  ...
  render () {
    ...
    const countCompletedItems = (todoList.filter(itemList => itemList.completed)).length;
    ...
    return (
        <div className="main">
          <div className="main__header">
            {isOpen && <BtnSelectAll selectedItem={this.handleSelectedItem} isAllChecked={countActiveItem === 0}/>}
            <Textarea 
